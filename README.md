...
|:-------|:-------|:-------|
| DirName | None | This is the alias for the directory inside /assets/. Usually, you can use the application name as a substitute, but it's best not to include spaces. |
